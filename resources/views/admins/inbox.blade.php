...
@section('link')
<!-- TABLE STYLES-->
<link href="{{ URL::asset('admin-public/js/dataTables/dataTables.bootstrap.css') }}" rel="stylesheet" />
@endsection
...
<!-- DATA TABLE SCRIPTS -->
<script src="{{ URL::asset('admin-public/js/dataTables/jquery.dataTables.js') }}"></script>
<script src="{{ URL::asset('admin-public/js/dataTables/dataTables.bootstrap.js') }}"></script>
<script>
