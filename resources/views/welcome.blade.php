				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-4 col-md-6">
							<div class="card border-0 med-blog">
								<div class="card-header p-0">
									<img class="card-img-bottom" src="{{ URL::asset('web-public/images/b1.jpg') }}" alt="Card image cap">
								</div>
						...
						<div class="col-lg-4 col-md-6 mt-md-0 mt-5">
							<div class="card border-0 med-blog">
								<div class="card-header p-0">
									<img class="card-img-bottom" src="{{ URL::asset('web-public/images/b2.jpg') }}" alt="Card image cap">
								</div>
								<div class="card-body border border-top-0 text-center">
			...
			<div class="row pt-xl-4">
				<div class="col-md-4 test-grid px-lg-5">
					<div class="test-info text-center">
						...
						<div class="test-img text-center mt-4">
							<img src="{{ URL::asset('web-public/images/te1.jpg') }}" class="img-fluid" alt="user-image">
						</div>
				...
				<div class="col-md-4 test-grid px-lg-5 my-md-0 my-5">
					<div class="test-info text-center">
						<p class="text-li">"Sed ut perspiciatis unde omnis iste natus error sit volup tatem accus antium dolore tium.</p>
						<div class="test-img text-center mt-4">
							<img src="{{ URL::asset('web-public/images/te2.jpg') }}" class="img-fluid" alt="user-image">
						</div>
				...
				<div class="col-md-4 test-grid px-lg-5">
					<div class="test-info text-center">
						<p class="text-li">"Sed ut perspiciatis unde omnis iste natus error sit volup tatem accus antium dolore tium.</p>
						<div class="test-img text-center mt-4">
							<img src="{{ URL::asset('web-public/images/te3.jpg') }}" class="img-fluid" alt="user-image">
						</div>
